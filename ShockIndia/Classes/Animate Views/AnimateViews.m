...
@synthesize animatedView, animationSubType, animationStartingFrame, callbackFunction, isForRemovingView,animationType;
...
- (void)startAnimationOnview:(UIView*)fromView toView:(UIView*)toView animationType:(int)animateType animationSubType:(NSString*)animateSubType {
